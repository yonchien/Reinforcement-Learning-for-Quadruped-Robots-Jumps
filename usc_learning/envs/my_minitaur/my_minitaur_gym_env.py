...
from usc_learning.envs.my_minitaur import my_minitaur
import os
...
class MinitaurBulletEnv(gym.Env):
  ...
  def __init__(
      self,
      urdf_root=pyb_data.getDataPath(),
      action_repeat=1,
      distance_weight=1.0,
      energy_weight=0.005,
      shake_weight=0.0,
      ...
      env_randomizer=my_minitaur_env_randomizer.MinitaurEnvRandomizer()):
  ...
  def reset(self):
    if self._hard_reset:
      ...
      self.minitaur = (my_minitaur.Minitaur(pybullet_client=self._pybullet_client,
