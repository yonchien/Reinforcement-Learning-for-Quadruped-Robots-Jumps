...
class FootTrajectoryGenerator(object):
    ...
    def __init__(self,
        ...
        # self.phi_i0 =  np.array([np.pi, np.pi, 0, 0 ])#np.zeros(4)
        # self.phi_i0 = np.zeros(4)
        # self.phi_i0 = np.pi* np.random.random(4)
        # nominal foot trajectory period in seconds
        self.T = T
